...
import { TemplateNotification } from "../../templateNotification/base/TemplateNotification";
...
export class NotificationResolverBase {
  ...
  async createNotification(
    ...
    return await this.service.createNotification({
      ...
      data: {
        ...
        templateNotification: args.data.templateNotification
          ? {
              connect: args.data.templateNotification,
            }
          : undefined,
      },
    });
  ...
  @graphql.ResolveField(() => TemplateNotification, {
    nullable: true,
  ...
  async getTemplateNotification(
    ...
    const result = await this.service.getTemplateNotification(parent.id);
